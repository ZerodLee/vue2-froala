...
[![npm](https://img.shields.io/npm/v/vue2-froala.svg)](https://www.npmjs.com/package/vue2-froala)
[![npm](https://img.shields.io/npm/dm/vue2-froala.svg)](https://www.npmjs.com/package/vue2-froala)
[![npm](https://img.shields.io/npm/l/vue2-froala.svg)](https://www.npmjs.com/package/vue2-froala)

>vue2-froala provides Vue bindings to the Froala WYSIWYG editor VERSION 2, adapted from [vue-froala-wysiwyg](https://www.npmjs.com/package/vue-froala-wysiwyg),thanks for the original authors.
...
Install `vue2-froala` from `npm`

```bash
npm install vue2-froala --save
```
...
import App from './App'
import Vue from 'vue'
import VueFroala from 'vue2-froala';
...
The `vue2-froala` project is under MIT license. However, in order to use Froala WYSIWYG HTML Editor plugin you should purchase a license for it.
...
If you want to contribute to vue2-froala, you will first need to install the required tools to get the project going.
